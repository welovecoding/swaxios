...
describe('MethodGenerator', () => {
  describe('constructor', () => {
    it('constructs a RESTful method name', () => {
      ...
      const methodDefinition = new MethodGenerator(url, method, responses, WireSSO);
      ...
      // TODO: Why is "parameterName" undefined?
    ...
    it('recognizes URL variables', () => {
      ...
      const method = 'delete';
      const responses = {'204': {description: ''}, '404': {description: '`id` not found'}};
